<?php include "../work_of_admin/price_detail/conn.php"; ?>
<!DOCTYPE html>
<html lang="en">
<head>
    <meta charset="UTF-8">
                ...
                if ($result->num_rows > 0) {
                    ...
                    while ($row = $result->fetch_assoc()) {
                        echo "<tr>
                                ...
                                <td>{$row['average']}</td>
                                <td>
                                   <a href='../work_of_admin/price_detail/priceUpdate.php?id={$row['id']}'>Update</a>
                                   <a href='../work_of_admin/price_detail/recordDelete.php?id={$row['id']}'>Delete</a>
                                </td>
                              </tr>";
                              $sn++;
                    }
