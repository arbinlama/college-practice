        ...
        if (isset($_GET['id'])) {
            ...
            if ($result->num_rows > 0) {
                ...
                echo "</ul>
                        ...
                        <div class='reg'>
                        <p>How to Register:</p>
                        <p class='reg1'>Register by filling out our registration form by clicking <a href='tRegister.php'>here</a></p>
                        <p class='reg1'> As the day of the workshop approaches, people who registered will get an email with a Zoom link to the online meeting.</p>
                        </div>
